...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.planner.straight_steering_trim, -30)
        ...
        self.assertFalse(config.planner.prealign_enabled)
        ...
        self.assertEqual(config.planner.prealign_timeout_s, 0.0)
        ...
        self.assertEqual(config.planner.path_confirm_frames, 1)
        ...
        self.assertTrue(config.planner.entry_setup_enabled)
        self.assertTrue(config.planner.early_entry_setup_enabled)
        self.assertEqual(config.planner.entry_setup_speed, 80)
        self.assertEqual(config.planner.entry_setup_steering, -150)
        self.assertEqual(config.planner.entry_setup_steer_settle_s, 0.30)
        self.assertEqual(config.planner.entry_setup_min_s, 1.00)
        self.assertEqual(config.planner.entry_setup_max_s, 3.00)
        self.assertEqual(config.planner.entry_setup_target_heading_deg, 60.0)
        self.assertEqual(config.planner.entry_setup_lateral_trigger_norm, 0.90)
        self.assertEqual(config.planner.max_steering, 150)
        self.assertEqual(config.planner.reverse_entry_min_steering, 90)
        self.assertEqual(config.planner.reverse_entry_steer_settle_s, 0.20)
        self.assertEqual(config.planner.reverse_entry_release_heading_deg, 8.0)
        self.assertEqual(config.planner.reverse_entry_release_confirm_frames, 2)
    ...
    def test_bev_and_lidar_debug_cli_overrides(self):
        args = parse_args([
            ...
            "--straight-steering-trim", "-35",
            "--entry-setup-speed", "70",
            "--entry-setup-steering", "-140",
        ...
        self.assertEqual(config.planner.entry_setup_speed, 70)
        self.assertEqual(config.planner.entry_setup_steering, -140)
